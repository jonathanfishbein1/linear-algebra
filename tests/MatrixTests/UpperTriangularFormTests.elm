          ...
          <|
            \_ ->
                let
                    matrix =
                        Matrix.Matrix
                            [ RowVector.RowVector <| Internal.Vector.Vector [ 3, 2, 3 ]
                            , RowVector.RowVector <| Internal.Vector.Vector [ 4, 6, 3 ]
                            , RowVector.RowVector <| Internal.Vector.Vector [ 1, 4, 4 ]
                            ]
                    ...
                    expected =
                        Matrix.Matrix
                            [ RowVector.RowVector <| Internal.Vector.Vector [ 3.0, 2, 3 ]
                            , RowVector.RowVector <| Internal.Vector.Vector [ 0.0, 3.3333333333333335, -1 ]
                            , RowVector.RowVector <| Internal.Vector.Vector [ 0.0, 0.0, 4 ]
                            ]
                            |> Matrix.map Real.Real
                in
          ...
          <|
            \_ ->
                let
                    matrix =
                        Matrix.Matrix
                            [ RowVector.RowVector <| Internal.Vector.Vector [ 0, 1, 0, 0, 312 ]
                            , RowVector.RowVector <| Internal.Vector.Vector [ 0, 0, 0, 1, 184 ]
                            , RowVector.RowVector <| Internal.Vector.Vector [ 0, 0, -2, 1, 0 ]
                            , RowVector.RowVector <| Internal.Vector.Vector [ -2, 1, 0, 0, 0 ]
                            ]
                            |> Matrix.map Real.Real
          ...
          <|
            \_ ->
                let
                    ...
                    expected =
                        Matrix.Matrix <|
                            [ RowVector.RowVector <| Internal.Vector.Vector [ ComplexNumbers.ComplexNumber (Real.Real 3.0) (Imaginary.Imaginary Real.zero), ComplexNumbers.ComplexNumber (Real.Real 2.0) (Imaginary.Imaginary Real.zero), ComplexNumbers.ComplexNumber (Real.Real 3) (Imaginary.Imaginary Real.zero) ]
                            , RowVector.RowVector <| Internal.Vector.Vector [ ComplexNumbers.ComplexNumber Real.zero (Imaginary.Imaginary Real.zero), ComplexNumbers.ComplexNumber (Real.Real 3.3333333333333335) (Imaginary.Imaginary Real.zero), ComplexNumbers.ComplexNumber (Real.Real -1) (Imaginary.Imaginary Real.zero) ]
                            , RowVector.RowVector <| Internal.Vector.Vector [ ComplexNumbers.ComplexNumber Real.zero (Imaginary.Imaginary Real.zero), ComplexNumbers.ComplexNumber Real.zero (Imaginary.Imaginary Real.zero), ComplexNumbers.ComplexNumber (Real.Real 4) (Imaginary.Imaginary Real.zero) ]
                            ]
                in
